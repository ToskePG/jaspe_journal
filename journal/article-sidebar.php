...
if($a_result["doi"]!=""){
	...
	$qrcodetext = rawurlencode("http://www.jaspe.ac.me/?sekcija=article&artid=" . $a_result["id"]);
}
?>
...
<?php
	...
	$apa .= "<i>Journal of Anthropology of Sport and Physical Education, " . $b_result["vol"] . "</i>(" . $b_result["no"] . "), " . $a_result["str"] . ".";
	...
	$mla .= "<i>Journal of Anthropology of Sport and Physical Education</i>, vol. " . $b_result["vol"] . ", no. " . $b_result["no"] . ", " . $b_result["godina"] . ", ";
	...
	$chi .= "<i>Journal of Anthropology of Sport and Physical Education</i> " . $b_result["vol"] . ", no. " . $b_result["no"] . " (" . $b_result["godina"] . "). ";
	$chi .= $a_result["str"] . ".";
...
<img width="180px" border="1" height="26px" src="http://api.elsevier.com/content/abstract/citation-count?scopus_id=<?php echo $a_result["scopus_id"]; ?>&httpAccept=image/jpeg&apiKey=abfff77d6e4a3d04c9f2f9dfe365b603" /><br />
<?php
}
?>
