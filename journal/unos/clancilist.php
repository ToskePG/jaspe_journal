...
class cclanci_list extends cclanci {
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->sazetak_eng); // sazetak_eng
			$this->UpdateSort($this->sazetak_mne); // sazetak_mne
	...
	function ResetCmd() {
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->sazetak_eng->setSort("");
				$this->sazetak_mne->setSort("");
...
<?php if ($clanci->sazetak_eng->Visible) { // sazetak_eng ?>
	<?php if ($clanci->SortUrl($clanci->sazetak_eng) == "") { ?>
		<td><div id="elh_clanci_sazetak_eng" class="clanci_sazetak_eng"><div class="ewTableHeaderCaption"><?php echo $clanci->sazetak_eng->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $clanci->SortUrl($clanci->sazetak_eng) ?>',1);"><div id="elh_clanci_sazetak_eng" class="clanci_sazetak_eng">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $clanci->sazetak_eng->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($clanci->sazetak_eng->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($clanci->sazetak_eng->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($clanci->sazetak_mne->Visible) { // sazetak_mne ?>
	<?php if ($clanci->SortUrl($clanci->sazetak_mne) == "") { ?>
		<td><div id="elh_clanci_sazetak_mne" class="clanci_sazetak_mne"><div class="ewTableHeaderCaption"><?php echo $clanci->sazetak_mne->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $clanci->SortUrl($clanci->sazetak_mne) ?>',1);"><div id="elh_clanci_sazetak_mne" class="clanci_sazetak_mne">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $clanci->sazetak_mne->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($clanci->sazetak_mne->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($clanci->sazetak_mne->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
...
<?php if ($clanci->references->Visible) { // references ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $clanci->SortUrl($clanci->references) ?>',1);"><div id="elh_clanci_references" class="clanci_references">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $clanci->references->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($clanci->references->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($clanci->references->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
...
<?php echo $clanci->sazetak_eng->ListViewValue() ?></span>
<a id="<?php echo $clanci_list->PageObjName . "_row_" . $clanci_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($clanci->sazetak_mne->Visible) { // sazetak_mne ?>
		<td<?php echo $clanci->sazetak_mne->CellAttributes() ?>>
<span<?php echo $clanci->sazetak_mne->ViewAttributes() ?>>
<?php echo $clanci->sazetak_mne->ListViewValue() ?></span>
<a id="<?php echo $clanci_list->PageObjName . "_row_" . $clanci_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($clanci->keywords_eng->Visible) { // keywords_eng ?>
