...
$autori_add = NULL; // Initialize page object first

class cautori_add extends cautori {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "autoriview.php")
...
// Create page object
if (!isset($autori_add)) $autori_add = new cautori_add();

// Page init
$autori_add->Page_Init();

// Page main
$autori_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$autori_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var autori_add = new ew_Page("autori_add");
autori_add.PageID = "add"; // Page ID
var EW_PAGE_ID = autori_add.PageID; // For backward compatibility

// Form object
var fautoriadd = new ew_Form("fautoriadd");

// Validate form
fautoriadd.Validate = function() {
...
fautoriadd.Form_CustomValidate = 
...
fautoriadd.ValidateRequired = true;
<?php } else { ?>
fautoriadd.ValidateRequired = false; 
<?php } ?>
...
<?php $autori_add->ShowPageHeader(); ?>
<?php
$autori_add->ShowMessage();
?>
<form name="fautoriadd" id="fautoriadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="autori">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_autoriadd" class="table table-bordered table-striped">
