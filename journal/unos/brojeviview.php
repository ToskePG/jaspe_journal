...
$brojevi_view = NULL; // Initialize page object first

class cbrojevi_view extends cbrojevi {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "brojevilist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "brojevilist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "brojevilist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($brojevi_view)) $brojevi_view = new cbrojevi_view();

// Page init
$brojevi_view->Page_Init();

// Page main
$brojevi_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$brojevi_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var brojevi_view = new ew_Page("brojevi_view");
brojevi_view.PageID = "view"; // Page ID
var EW_PAGE_ID = brojevi_view.PageID; // For backward compatibility

// Form object
var fbrojeviview = new ew_Form("fbrojeviview");

// Form_CustomValidate event
fbrojeviview.Form_CustomValidate = 
...
fbrojeviview.ValidateRequired = true;
<?php } else { ?>
fbrojeviview.ValidateRequired = false; 
<?php } ?>
...
<?php $brojevi_view->ExportOptions->Render("body") ?>
<?php if (!$brojevi_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($brojevi_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $brojevi_view->ShowPageHeader(); ?>
<?php
$brojevi_view->ShowMessage();
?>
<form name="fbrojeviview" id="fbrojeviview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="brojevi">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_brojeviview" class="table table-bordered table-striped">
...
<?php echo $brojevi->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($brojevi->broj->Visible) { // broj ?>
	<tr id="r_broj">
		<td><span id="elh_brojevi_broj"><?php echo $brojevi->broj->FldCaption() ?></span></td>
...
<?php echo $brojevi->broj->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($brojevi->period_eng->Visible) { // period_eng ?>
	<tr id="r_period_eng">
		<td><span id="elh_brojevi_period_eng"><?php echo $brojevi->period_eng->FldCaption() ?></span></td>
...
<?php echo $brojevi->period_eng->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($brojevi->period_mne->Visible) { // period_mne ?>
	<tr id="r_period_mne">
		<td><span id="elh_brojevi_period_mne"><?php echo $brojevi->period_mne->FldCaption() ?></span></td>
...
<?php echo $brojevi->period_mne->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($brojevi->godina->Visible) { // godina ?>
	<tr id="r_godina">
		<td><span id="elh_brojevi_godina"><?php echo $brojevi->godina->FldCaption() ?></span></td>
...
<?php echo $brojevi->godina->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($brojevi->file->Visible) { // file ?>
	<tr id="r_file">
		<td><span id="elh_brojevi_file"><?php echo $brojevi->file->FldCaption() ?></span></td>
...
<?php echo $brojevi->file->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
