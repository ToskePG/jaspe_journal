...
define("EW_ROOT_RELATIVE_PATH", "C:\Users\User\Documents\PHPMaker\Projects\jaspe", TRUE); // Relative path of app root
...
define("EW_PROJECT_NAME", "jaspe", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{3D7A0815-42DE-4706-A688-045439C7A049}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'VT2fwiICfJjmv0ro', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/jaspe.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_USER", 'jaspe', TRUE);
define("EW_CONN_PASS", 'FRgJsP!32GC#', TRUE);
define("EW_CONN_DB", 'jaspe', TRUE);
...
// Security
define("EW_ADMIN_USER_NAME", "jaspe", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "mj10ssm24", TRUE); // Administrator password
