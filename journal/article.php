...
<p><span class="artlink-manji">
		...
		<?php echo $b_result["vol"]; ?>(<?php echo $b_result["no"]; ?>), <?php echo $a_result["str"]; ?>
		<?php if ($a_result["doi"] != "") { ?>
			| DOI: <a href="https://doi.org/<?php echo $a_result["doi"]; ?>"
				target="_blank"><?php echo $a_result["doi"]; ?></a>
		</span></p>
<?php } ?>
...
<p style="text-align:center;"><span class="artlink"><a href="/clanci/<?php echo $a_result["file"]; ?>"
			onclick="brojac(<?php echo $a_result["id"]; ?>)" target="_blank">
			<img src="images/pdf64.gif" /><br />
			View full article<br />
			(PDF – <?php
			if ($a_result['id'] != 238) {
				echo round(filesize("clanci/" . $a_result["file"]) / 1024) . "KB)";
			} else
				echo "98KB)"
					?>
			</a></span></p>
...
<script>
	...
	*  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/
	...
	var disqus_config = function () {
		this.page.url = 'http://www.jaspe.ac.me/?sekcija=article&artid=<?php echo $a_result["id"]; ?>';  // Replace PAGE_URL with your page's canonical URL variable
